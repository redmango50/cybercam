class ReasonSection extends HTMLElement{
    ...
    <div class="about">
        <div class="cart">
            <img src="https://raw.githubusercontent.com/redmango50/cybercam/main/static-assets/dataprot.svg"/>
                <h2>Data Protection</h2>
                <p>Protect your personal information because if it's stolen, it can be used against you</p>
        </div>
        <div class="cart">
            <img src="https://raw.githubusercontent.com/redmango50/cybercam/main/static-assets/financial-security-svgrepo-com.svg"/>
                <h2>Financial Security</h2>
                <p>Protect your money and accounts because if they’re hacked, you could lose everything</p>
        </div>
        <div class="cart">
            <img src="https://raw.githubusercontent.com/redmango50/cybercam/main/static-assets/identity_theft.svg"/>
                <h2>Identity Theft</h2>
                <p>Protect your personal details because if someone steals them, they can pretend to be you</p>
        </div>
        <div class="cart">
            <img src="https://raw.githubusercontent.com/redmango50/cybercam/main/static-assets/call-svgrepo-com.svg"/>
